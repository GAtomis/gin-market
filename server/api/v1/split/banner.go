...
var bannerService = service.ServiceGroupApp.SplitServiceGroup.BannerService
...
// @accept application/json
// @Produce application/json
// @Param data body split.Banner true "删除Banner"
...
// @accept application/json
// @Produce application/json
// @Param data body split.Banner true "更新Banner"
...
// @accept application/json
// @Produce application/json
// @Param data query split.Banner true "用id查询Banner"
...
// @accept application/json
// @Produce application/json
// @Param data query splitReq.BannerSearch true "分页获取Banner列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /banner/getBannerList [get]
func (bannerApi *BannerApi) GetBannerList(c *gin.Context) {
	var pageInfo splitReq.BannerSearch
