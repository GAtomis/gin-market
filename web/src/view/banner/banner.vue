  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      <el-table ref="multipleTable" style="width: 100%" tooltip-effect="dark" :data="tableData" row-key="ID"
        ...
        <el-table-column align="left" label="轮播图地址" width="200">
          <template #default="scope">
            <el-image style="width: 150px;" :src="scope.row.url" 
              fit="cover" />
          </template>


        </el-table-column>
        <el-table-column align="left" label="轮播图介绍" prop="description" width="120" />
        <el-table-column align="left" label="轮播图点击地址" prop="path" width="400" />
        <el-table-column align="left" label="按钮组" width="150">
          <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button"
              @click="updateBannerFunc(scope.row)">变更</el-button>
...
const previewList=computed(()=>tableData.value.map(item=>item.url))
